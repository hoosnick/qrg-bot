...
class Buttons:
    def __init__(self):
        ...
        self.IQRCP = types.InlineQueryResultCachedPhoto
    ...
    def inlinePhoto(self, id: int, img: dict) -> types.InlineQueryResultCachedPhoto:
        return self.IQRCP(id=id, title="qr_code", photo_file_id=img["photo_file_id"])
